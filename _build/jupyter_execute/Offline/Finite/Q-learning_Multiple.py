...
# ## Key Steps
# **Policy Learning:**
# 1. At the final decision point $t=T$, fitted a model $\hat{Q}_{T}(h_{T},a_{T},\hat{\beta}_{T})$ for the observed outcome $R$;
...
# \begin{align}
# \tilde{R}_{t} = \hat{Q}_{t}(h_{t},d_{t}(h_{t}),\hat{\beta}_{t}),
