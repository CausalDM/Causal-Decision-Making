...
# \end{equation*}   
# Following the doubly robust value estimator in \cite{dudik2011doubly}, we propose the doubly robust mean outcome estimator as the value estimator under the optimal policy as
